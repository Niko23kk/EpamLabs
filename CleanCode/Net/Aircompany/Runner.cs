...
namespace Aircompany
{
    public class Runner
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(militaryAirport.GetAirportWithSortedPlanesByMaxFlightDistance().ToString());
            Console.WriteLine(passengerAirport.GetAirportWithSortedPlanesByMaxSpeed().ToString());
